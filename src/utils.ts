import {Occurrence, TranslationResponseItem, WordGroups} from "./components/VocabOutput/types";

export const organiseVocab = (translationResponse: TranslationResponseItem[]) => {
