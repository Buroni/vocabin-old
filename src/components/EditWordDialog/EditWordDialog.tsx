...
export const EditWordDialog = (p: Props) => {
    const [editingWordItem, setEditingWordItem] = useState<TranslationResponseItem | null>(p.wordItem);
    ...
    return (
        <Dialog isOpen={isOpen} onClose={p.close} canOutsideClickClose>
            <div className="bp3-dialog-header">
                ...
                <Button aria-label="Close" className="bp3-dialog-close-button" icon={"cross"} onClick={p.close}/>
            </div>
            {p.wordItem &&
            ...
            {editingWordItem &&
                <div className="bp3-dialog-footer">
                    <div className="bp3-dialog-footer-actions">
                        <Button icon={"floppy-disk"} onClick={() => p.save(editingWordItem)}>Save Changes</Button>
                    </div>
                </div>
            }
        </Dialog>
